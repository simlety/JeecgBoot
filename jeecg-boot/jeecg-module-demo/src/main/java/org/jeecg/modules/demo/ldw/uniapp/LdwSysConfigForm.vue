<template>
    <view>
		...
		<cu-custom :bgColor="NavBarColor" isBack :backRouterName="backRouteName">
			...
			<block slot="content">ldw_sys_config</block>
		</cu-custom>
		 <!--表单区域-->
		<view>
			<form>
              <view class="cu-form-group">
                <view class="flex align-center">
                  <view class="title"><text space="ensp">配置键（唯一标识）：</text></view>
                  <input  placeholder="请输入配置键（唯一标识）" v-model="model.configKey"/>
                </view>
              </view>
              <view class="cu-form-group">
                <view class="flex align-center">
    ...
    export default {
        ...
        data(){
            return {
                ...
                backRouteName:'index',
                url: {
                  queryById: "/ldw/ldwSysConfig/queryById",
                  add: "/ldw/ldwSysConfig/add",
                  edit: "/ldw/ldwSysConfig/edit",
                },
            }
        },
        created(){
